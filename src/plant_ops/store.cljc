(ns plant-ops.store
  "PlantOpsStore protocol — backing store for power plant operations
  coordination: registered plants/units, committed operation records,
...
(defprotocol Store
  "A backing data store for plant operations coordination."
